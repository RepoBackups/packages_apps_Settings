...
mRashed97 = prefSet.findPreference("candy_Rashed97");
}
@Override
...
Toast.LENGTH_LONG).show();
} else if (preference == mRashed97) {
Toast.makeText(getActivity(), "CM Recruit, what am I doing here again?",
Toast.LENGTH_LONG).show();
} else {
